...
<div id="content">
  ...
  <div class="box">
    ...
    <?php if ($module['position'] == 'slider_nax') { ?>
    <option value="slider_nax" selected="selected">Slider Nax!</option>
    <?php } else { ?>
    <option value="slider_nax">Slider Nax!</option>
    <?php } ?>
...
function addModule() {	
    ...
    html += '      <option value="slider_nax">Slider Nax</option>';
